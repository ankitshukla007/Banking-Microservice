...
@Tag(
        ...
        description = "CRUD REST APIs for create, update, delete and fetch account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to get Get Build Information"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to get Get Java Version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to get Get Contact Information  "
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
